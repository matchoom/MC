...
<div>
	<div class="wrap">
		<div>
			...
			<input type="text" class="datepicker" style="width: 100px" id="datepicker1" autocomplete="off">
		</div>
		&nbsp;
		<div>
			<label></label><br>
		...
		<div>
			...
			<input type="text" class="datepicker" style="width: 100px" id="datepicker2" autocomplete="off">
		</div>
		&nbsp;
		<div>
