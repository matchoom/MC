...
<script type="text/javascript">
	function modifyMemberPassword() {
		...
		const url = "https://d1b8-58-224-53-148.ngrok.io/PetInDelight/modifyMemberPassword.do"; 
	...
	function modifyMemberNickname() {
		...
		const url = "https://d1b8-58-224-53-148.ngrok.io/PetInDelight/modifyMemberNickname.do";
	...
	function modifyMemberTelNumber() {
		...
		const url = "https://d1b8-58-224-53-148.ngrok.io/PetInDelight/modifyMemberTelNumber.do";
