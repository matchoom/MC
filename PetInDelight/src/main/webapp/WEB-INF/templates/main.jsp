...
margin: 0;
height: 100%;
 background-image: url("${pageContext.request.contextPath}/resource/img/main3.png");
...
<div align="center">
  	<br><br><br>
   	<h1 style="color:black" ><b>행복한 반려견들의 공간</b></h1>
     <h4><p style="color:black" ><b>Pet In Delight에서 반려견들에게 행복한 추억을 선물하세요.</b></p><br/></h4><br>
    <!-- <img src="${pageContext.request.contextPath}/resource/img/2.png" height="50%" width="100%"> <br><br> --> 
     <img src="${pageContext.request.contextPath}/resource/img/petindelight.png" style="max-width:1000px; height:auto;"><br><br><br>
     
     <h4>
     <p style="color:black">
     <b>    
     <span>
     Pet In Delight를 방문해 주셔서 감사합니다.<br><br>
     저희 Pet In Delight는 반려견과 보호자님을 위한 호텔서비스를 한곳에 모았습니다.<br><br>
...
<div>
   <div id="wrap">
      <div>
         <label  style="color:black" for="datepicker1">체크인</label><br>
         <input type="text" class="datepicker" id="datepicker1" style="width: 100px" autocomplete="off">
      </div>
      &nbsp;
      <div>
         <label></label><br>
      ...
      &nbsp;
      <div>
         &nbsp;<label style="color:black" for="datepicker2">체크아웃</label><br>
         <input type="text" class="datepicker" id="datepicker2" style="width: 100px" autocomplete="off">
      </div>
      &nbsp;
      <div>
         <label style="color:black" for="animalcnt">마리 수</label><br>
      ...
      if($('#datepicker1').val() == ""){
         ...
         $.ajax({
            ...
            success: function(data){
               $('#showRoom').html(data);
               document.getElementById("showRoom").scrollIntoView(true);
            }
         });
      }            
   });
